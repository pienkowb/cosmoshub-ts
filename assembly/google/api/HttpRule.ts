...
export function encodeHttpRule(message: HttpRule): Uint8Array {
  return Protobuf.encode(message, HttpRule.encode);
}

export function decodeHttpRule(buffer: Uint8Array): HttpRule {
  return Protobuf.decode<HttpRule>(buffer, HttpRule.decode);
}

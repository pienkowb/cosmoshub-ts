...
export function encodeHttp(message: Http): Uint8Array {
  return Protobuf.encode(message, Http.encode);
}

export function decodeHttp(buffer: Uint8Array): Http {
  return Protobuf.decode<Http>(buffer, Http.decode);
}
